...
public abstract class ControllerBase {
    ...
    /**
     * This method will render the jsp file in the `path' parameter. You can
     * override this method to render other template system.
     *
    ...
    /**
     * Use the action method name to find the bean name. If your package prefix
     * name is "com.lvup.web.test." and the action method is "Login", then the
     * class name should be "com.lvup.web.test.bean.Login"
     *
     * @return
    ...
    public String filterXSSCode(String input) {
        // To filter out XSS Javascript, take any "()" out of this pathinfo
        String s = "()[]{}\\";
        String r = "///////";
        return StringUtils.replaceChars(input, s, r);       
    }
    ...
    public String getFormAction() {
        ...
        try {
            if (contextPath == null) {
                ...
                formString = this.getRequest().getContextPath() + this.getRequest().getServletPath()
                        + (StringUtils.isEmpty(pathInfo) ? "" : 
                        StringEscapeUtils.escapeHtml(filterXSSCode(pathInfo)))
                ...
                formString = contextPath.toString()
                        + request.getAttribute("javax.servlet.forward.servlet_path").toString()
                        + ((pathInfo == null) ? "" : filterXSSCode(pathInfo.toString()))
